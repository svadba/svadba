        ...
        <div class="">
            <div class="panel panel-default">
                ...
                <form style="max-width:300px; margin:20px auto;" action="{{ url('contractors/save') }}" method="POST" class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="">
                      <input type="text" name="middlename" placeholder ="Отчество" id="middlename" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="">
                      <input type="text" name="email" placeholder ="Электронная почта" id="middlename" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="">
                      <input type="text" name="birthday" id="birthday" placeholder ="Дата рождения (ДД-ММ-ГГГГ):" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="">
                      <input type="text" name="address" id="address" placeholder ="Адрес" class="form-control"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="">
